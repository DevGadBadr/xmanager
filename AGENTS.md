...
### Production server
- Public URL: `https://xmanager.devgadbadr.com`
...
- Canonical auth URL: `https://xmanager.devgadbadr.com/api/auth`
- Canonical app URL: `https://xmanager.devgadbadr.com`
- Reverse proxy: Nginx proxies `/` to `http://localhost:3008`

### Development server
- Public URL: `https://devgadbadr.com/xmanager`
...
- Canonical auth URL: `https://devgadbadr.com/xmanager/api/auth`
- Canonical app URL: `https://devgadbadr.com/xmanager`
- Reverse proxy: Nginx keeps the `/xmanager` prefix intact and proxies to `http://127.0.0.1:3018`
- TLS: Let's Encrypt cert at `/etc/letsencrypt/live/xmanager.devgadbadr.com/`
...
- Development must keep the `/xmanager` base path.
...
- Repo reference template for prod host: `/root/Gad/web/Apps/xmanager/infra/nginx/xmanager.devgadbadr.com.conf`

### Operational cautions
- Do not remove the dev `/xmanager` base-path behavior unless explicitly requested.
